...
import argparse
import numpy as np
from model.vgg_Capsule_Net import Capsule as capsule_net
...
train_dataset = datasets.CIFAR100('../data', train=True, download=True, transform=transforms_train)
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True)

test_dataset = datasets.CIFAR100('../data', train=False, download=True, transform=transforms_test)
...
net = capsule_net('VGG11', num_units=16, num_class=num_class, image_channels=image_channels)
